...
public class WizardAnvil extends MagicPattern {
    public WizardAnvil() {
        ...
        keys = new Material[]{ Material.ANVIL };
                        ...
                        if ( damage > 0 ) {
                            ...
                            if ( ExpHelper.spendExp( player, damage ) ) {
                                ...
                                if ( exp > 0 && ExpHelper.spendExp( player, exp ) ) {
                                    ...
                                    item.setItemMeta( meta );
                                    player.sendMessage( ChatColor.AQUA + "Your magic partially repaired " + String.valueOf( exp ) + " damage (out of " + strDam + " damage) on " + iName );
                                }
                                break;
                            }
                        }

    ...
    public static void eatWizardFood(ItemStack food, WizardPlayer wizardPlayer ) {
        if ( isWizardFood( food ) ) {
            ...
            if ( foodName.equals( "Cockatrice Cookies" ) ) {
                ...
                PotionEffect hunger = new PotionEffect( PotionEffectType.HUNGER, 200, 40 );
                ...
                wizardPlayer.gainWizardPower( 25 );
                PotionEffect confusion = new PotionEffect( PotionEffectType.CONFUSION, 200, 1 );
                PotionEffect levitation = new PotionEffect( PotionEffectType.LEVITATION, 200, 1 );
                wizardPlayer.getPlayer().addPotionEffect( confusion );
                wizardPlayer.getPlayer().addPotionEffect( levitation );
            }
        }
